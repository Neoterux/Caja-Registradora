...
public class ClientDaoImpl implements ClientsDAO{
    ...
    public boolean register(Clients client) {
        ...
        try(Connection con = proyecto.BD.Connection.connect(DEBUG);){
    ...
    public boolean update(Clients client) {
       boolean updated = false;
        ...
        try (Connection conn = proyecto.BD.Connection.connect(DEBUG)){
            ...
            dbg = new DbgMessage(this, CrudType.UPDATE, stm.executeUpdate());
            dbg.showCrudDbg();
            conn.close();
            updated = true;
